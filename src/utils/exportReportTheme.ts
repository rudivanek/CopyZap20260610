...
.rank-row{display:grid;grid-template-columns:34px 1fr 90px 90px 90px 90px;gap:14px;align-items:center;padding:18px 22px;border-bottom:1px solid var(--line-soft)}
